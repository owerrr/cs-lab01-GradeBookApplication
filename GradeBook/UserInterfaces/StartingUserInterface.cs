...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            {
                case "standard":
                    StandardGradeBook stdGradeBook = new StandardGradeBook(name, Convert.ToBoolean(parts[3]));
                    Console.WriteLine("Created gradebook {0}.", name);
                    GradeBookUserInterface.CommandLoop(stdGradeBook);
                    break;
                case "ranked":
                    RankedGradeBook rnkGradeBook = new RankedGradeBook(name, Convert.ToBoolean(parts[3]));
                    Console.WriteLine("Created gradebook {0}.", name);
